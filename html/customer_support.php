...
<html lang="en">
  <head>
    ...
    <title>Support Center | AP Tec</title>
  ...
  <body>
    <div class="dashboard-container">
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item">
            <a href="customer_invoices.php" class="nav-link"
              ><i class="fa-solid fa-file-invoice-dollar"></i> Invoices</a
            >
          </li>
          <li class="nav-item">
      ...
      <main class="main-content">
        <header class="top-bar">
          <div class="page-title">
            ...
            <p style="color: var(--secondary)">
              Track issues and find quick answers.
            </p>
          </div>
        ...
        <div class="dashboard-grid">
          ...
          <div class="stat-card">
            <div class="stat-info">
              <h3 style="color: #64ffda">2h 15m</h3>
              <p>Avg. Response</p>
            </div>
          ...
          >
            ...
            <div style="display: flex; gap: 10px">
              <button class="btn btn-primary trigger-live-chat">
          ...
          >
            <div
              ...
              "
            >
              <h3 style="color: white">Ticket History</h3>
              <button
                class="btn btn-primary"
                onclick="openModal('createTicketModal')"
            ...
            >
              ...
              <tbody>
                <tr>
                  <td class="font-mono">#TCK-9923</td>
                  <td>Server Room Overheating</td>
                  <td>Feb 07, 2026</td>
                  <td>
                  ...
                  <td style="position: relative; overflow: visible">
                    <div class="action-container">
                      ...
                      <div class="action-menu">
                        <button
                          class="action-item"
                          onclick="openModal('viewTicketModal')"
                        >
                          <i class="fa-solid fa-eye"></i> View Details
                        </button>
                        <button
                          class="action-item"
                          onclick="openModal('editTicketModal')"
                        >
                ...
                <tr>
                  <td class="font-mono">#TCK-9801</td>
                    ...
                    <div class="action-container">
                      ...
                      <div class="action-menu">
                        ...
                        <button class="action-item">
                          <i class="fa-solid fa-download"></i> Archive
                        </button>
                      </div>
                    </div>
                  </td>
          ...
          <div class="wide-widget" style="grid-column: span 1; height: auto">
            <h3 style="color: white; margin-bottom: 20px">FAQs</h3>
            <div class="accordion-item">
              <div class="accordion-header">
                <span class="accordion-title">How to reset printer?</span
                ><i class="fa-solid fa-chevron-down accordion-icon"></i>
              </div>
              <div class="accordion-body">
                Turn off printer. Hold "Resume" for 5s.
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal-overlay" id="createTicketModal">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h2>Open Ticket</h2>
          <p style="color: var(--secondary)">Describe issue.</p>
        </div>
        <form>
          ...
          <div class="form-group">
            <label class="form-label" style="color: var(--secondary)"
              >Description</label
            ><textarea class="modal-input" rows="4"></textarea>
          </div>
    ...
    <div class="modal-overlay" id="editTicketModal">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h2>Edit Ticket</h2>
          <p style="color: var(--secondary)">ID: #TCK-9923</p>
        </div>
        <form>
          <div class="form-group">
            <label class="form-label" style="color: var(--secondary)"
              >Update Note</label
            ><textarea class="modal-input" rows="4">Issue persists.</textarea>
          </div>
          <div style="display: flex; gap: 15px; margin-top: 20px">
            <button
              type="button"
    ...
    <div class="modal-overlay" id="viewTicketModal">
      <div class="modal-content">
        <i
          class="fa-solid fa-xmark close-modal"
          onclick="closeModal('viewTicketModal')"
        ></i>
        <div class="modal-header">
        ...
        >
          ...
          />
          <p style="color: #ddd">
            The main server rack is reaching 85°C. AC unit seems to be
            malfunctioning.
          </p>
        </div>
        <h4 style="color: var(--primary)">Technician Reply:</h4>
        <div style="display: flex; gap: 10px; margin-top: 10px">
          <div class="user-avatar" style="width: 30px; height: 30px">JS</div>
          <p style="color: white; font-size: 0.9rem">
            "I am on my way. ETA 20 mins."
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="modal-overlay" id="callModal">
      <div class="modal-content" style="text-align: center">
        ...
        <h2 style="color: white">+94 11 234 5678</h2>
        ...
        >
          <p style="font-size: 0.85rem; color: white">
            <strong>General Inquiries:</strong> 9:00 AM - 5:00 PM
          </p>
        </div>
        <button
          class="btn btn-primary"
    ...
    <div class="modal-overlay" id="deleteModal">
      <div class="modal-content" style="text-align: center">
        ...
        ></i>
        <h2 style="color: white">Cancel Ticket?</h2>
        <p style="color: var(--secondary); margin-bottom: 25px">
          Are you sure you want to cancel this support request? This action
          cannot be undone.
        </p>
    ...
    <div class="live-chat-panel" id="liveChatPanel">
      <div class="chat-panel-header">
        <h4>Support Agent</h4>
        <button class="btn-close-chat" id="closeLiveChat">
          <i class="fa-solid fa-xmark"></i>
        </button>
      </div>
      <div class="chat-panel-body" id="popupChatBody">
        <div class="message-bubble msg-in">Hello! How can I help?</div>
      </div>
    ...
    <script src="../js/customer_support.js"></script>
    <script src="../js/live_chat_popup.js"></script>
    ...
    <script>
      function openModal(id) {
        ...
        document
          .querySelectorAll(".action-menu.active")
