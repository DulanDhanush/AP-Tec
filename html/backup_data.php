...
<html lang="en">
  <head>
    ...
    <style>
      /* Page Specific Styles for Upload Zone */
      .upload-zone {
        ...
        <ul class="nav-menu">
          ...
          <li class="nav-item">
            <a href="user_management.php" class="nav-link"
              ><i class="fa-solid fa-users"></i> User Mgmt</a
            >
          </li>
          <li class="nav-item">
            <a href="system_logs.php" class="nav-link"
              ><i class="fa-solid fa-shield-halved"></i> System Logs</a
            >
          </li>
          <li class="nav-item">
    ...
    <?= strtoupper(substr($userName, 0, 1)) ?>
        ...
        <div class="dashboard-grid">
          <div class="wide-widget" style="height: auto; min-height: 250px">
            ...
            >
              ...
              <span id="backupStatus" class="status-badge status-active"
                >Secure</span
              >
            </div>
          ...
          <div class="wide-widget" style="height: auto; min-height: 250px">
            <h3 style="color: white; font-size: 1.2rem; margin-bottom: 5px">
              Restore Data
            </h3>
            <p
              style="
        ...
        <div class="settings-group">
          ...
          <div class="setting-item">
            <div>
              <h4 style="color: white; font-size: 1rem">
        ...
        <div
          class="wide-widget"
          style="height: auto; min-height: 400px; grid-column: span 4"
        >
          <div
            style="
              display: flex;
          ...
          <table class="table-responsive">
            ...
            <tbody>
              <tr>
                <td class="font-mono">BK-2026-02-07</td>
                <td>Feb 07, 2026 - 03:00 AM</td>
                <td>42.5 MB</td>
                <td><span style="color: var(--primary)">Automated</span></td>
                <td>
                  <span class="status-badge status-active">Verified</span>
                </td>
                <td>
                  <div class="action-buttons">
                    <button class="btn-icon btn-view" title="Download">
              ...
              <tr>
                <td class="font-mono">BK-2026-02-06</td>
                <td>Feb 06, 2026 - 03:00 AM</td>
                <td>41.8 MB</td>
                <td><span style="color: var(--primary)">Automated</span></td>
                <td>
                  <span class="status-badge status-active">Verified</span>
              ...
              <tr>
                <td class="font-mono">BK-MANUAL-001</td>
                <td>Feb 05, 2026 - 02:15 PM</td>
                <td>41.2 MB</td>
                <td><span style="color: #f1c40f">Manual</span></td>
                <td>
                  <span class="status-badge status-active">Verified</span>
                </td>
                <td>
